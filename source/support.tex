...
\begin{itemdescr}
\pnum
\expects \tcode{p} is a reference to a promise object of a coroutine.
...
\begin{itemdescr}
\pnum
\expects \tcode{addr} was obtained via a prior call to \tcode{address}.
...
\begin{itemdescr}
\pnum
\expects \tcode{*this} refers to a suspended coroutine.
...
\begin{itemdescr}
\pnum
\expects \tcode{*this} refers to a coroutine.
