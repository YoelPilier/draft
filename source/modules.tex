...
\nontermdef{global-module-fragment}\br
    module-keyword \terminal{;} \opt{top-level-declaration-seq}
\end{bnf}
...
in the \grammarterm{top-level-declaration-seq}\iref{cpp.pre}.
\end{note}
...
\nontermdef{private-module-fragment}\br
    module-keyword \terminal{:} \keyword{private} \terminal{;} \opt{top-level-declaration-seq}
\end{bnf}
