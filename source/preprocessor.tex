...
\item
an \tcode{import} preprocessing token
...
\item
a \tcode{module} preprocessing token
...
\nontermdef{pp-global-module-fragment}\br
    \terminal{module ;} new-line \opt{group}
\end{bnf}

\begin{bnf}\obeyspaces
\nontermdef{pp-private-module-fragment}\br
    \terminal{module : private ;} new-line \opt{group}
\end{bnf}
...
\nontermdef{pp-module}\br
    \opt{\terminal{export}} \terminal{module} \opt{pp-tokens} \terminal{;} new-line
\end{bnf}
...
appear where \tcode{export} is an identifier defined as an object-like macro
...
\pnum
If an \grammarterm{import-directive} is produced by source file inclusion
